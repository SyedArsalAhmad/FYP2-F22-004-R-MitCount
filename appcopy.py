...
def handle_form_submission():
    if request.method == "POST":
        ...
        if machine==('A'):
            ...
            path = ".//runs//detect//predict//labels//2.txt"
            ...
            # calling mitcount function

            file_path = 'D:/fypmodels/copy_mitwebb/runs/detect/predict/labels/'
            ...
            path = ".//runs//detect//predict2//labels//2.txt"
            if os.path.isfile(path):
                os.remove(path)
            ...
            file_path = 'D:/fypmodels/copy_mitwebb/runs/detect/predict2/labels/'  
            line_count = count_lines(file_path)
            print("Number of lines in the file:", line_count)


            img_path = fr"D:\fypmodels\copy_mitwebb\runs\detect\predict2\2.jpg"
            print("________________________")
